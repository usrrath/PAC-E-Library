...
class AppSettings {
  ...
  static Future<double> loadFontScale() async {
    ...
    return (parsed ?? 1.0).clamp(0.80, 1.15).toDouble();
  }
...
class AppProvider extends StatelessWidget {
  ...
  static Future<void> init() async {
    themeMode.value = await AppSettings.loadThemeMode();
    fontScale.value = await AppSettings.loadFontScale();
    locale.value = await AppSettings.loadLocale();
  }
